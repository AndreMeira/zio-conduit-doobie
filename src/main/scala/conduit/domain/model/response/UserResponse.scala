...
object UserResponse:
  type Type = AuthenticationResponse | GetProfileResponse
  ...
  type Of[A <: UserRequest] = A match
    ...
    case FollowUserRequest   => GetProfileResponse
    case GetProfileRequest   => GetProfileResponse
    case UnfollowUserRequest => GetProfileResponse
